...
public class BaseITCase {
    ...
    private static final String MYSQL_CONTAINER_NAME = "${rootArtifactId}_db_container";
    private static Logger logger;
    private static final int MYSQL_PORT = 10603;
    private static final String MYSQL_SCHEMA = "${rootArtifactId}_integration_test";
