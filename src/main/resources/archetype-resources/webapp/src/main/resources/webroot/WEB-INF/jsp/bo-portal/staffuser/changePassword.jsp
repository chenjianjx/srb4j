      ...
      <div class="card card-login mx-auto mt-5">
        ...
        <div class="card-body">
          ...
          <form action="/bo/portal/staffusers/admin/change-password" method="post" novalidate>
            ...
            <c:if test="${dollar}{it.changeReason != null}">
                <div class="form-group">
                    <div class="text-info"> <c:out value="${dollar}{it.changeReason}"/> </div>
                </div>
            </c:if>

            <div class="form-group">
              <div class="form-label-group">
                <input type="text" id="username" name="username" value="${dollar}{sessionStaffUser.username}"
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="password" id="currentPassword" name="currentPassword" value="${dollar}{it.currentPassword}"
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="password" id="newPassword" name="newPassword" value="${dollar}{it.newPassword}"
            ...
            <div class="form-group">
              <div class="form-label-group">
                <input type="password" id="confirmPassword" name="confirmPassword" value="${dollar}{it.confirmPassword}"
