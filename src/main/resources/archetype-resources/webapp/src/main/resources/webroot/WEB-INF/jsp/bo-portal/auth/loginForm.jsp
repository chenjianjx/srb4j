  ...
  <body class="bg-dark">
    ...
    <div class="container">
      <div class="card card-login mx-auto mt-5">
        <div class="card-header">${capitalizedRootArtifactId} Back Office</div>
        <div class="card-body">
          ...
          <form action="/bo/portal/login" method="post" class="needs-validation" novalidate>
            ...
            <div class="form-group">
              <div class="form-label-group">
                ...
                <input type="text" id="username" name="username" value="${dollar}{it.username}"
            ...
            <div class="form-group">
              <div class="form-label-group">
                ...
                <input type="password" name="password" type="password" value="${dollar}{it.password}"
