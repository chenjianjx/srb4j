package ${groupId}.${rootArtifactId}.webapp.fo.rest.auth;
...
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.LONG_SESSION_PARAM;
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.LONG_SESSION_TIP;
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.OAUTH2_ACCESS_TOKEN_NAME_TIP;
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.OAUTH2_FLOW_TIP;
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.OAUTH2_GRANT_TYPE_TIP;
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.OAUTH2_TOKEN_ENDPOINT_ERR_TIP;
import static ${groupId}.${rootArtifactId}.intf.fo.basic.FoConstants.OAUTH2_TOKEN_ENDPOINT_TIP;
...
import ${groupId}.${rootArtifactId}.webapp.infrahelper.rest.OAuth2RequestWrapper;
